...
class XSLTExtension(object):
    ...
    def apply_templates(self, context, node, output_parent=None,
        ...
        case.
        """
        assert context._xsltCtxt, "XSLT context not initialised"
    ...
    def process_children(self, context, output_parent=None,
                         elements_only=False, remove_blank_text=False):
        ...
        case.
        """
        c_ctxt = context._xsltCtxt
        c_old_output_parent = c_ctxt.insert
        assert context._xsltCtxt, "XSLT context not initialised"
    ...
    def _collectXSLTResultContent(self, context, c_parent,
                                  elements_only, remove_blank_text):
...
def _registerXSLTExtensions(c_ctxt, extension_dict):
...
def _callExtensionElement(c_ctxt,
    ...
    try:
        try:
            try:
                dict_result = context._extension_elements[uri, node_name]
            except KeyError:
                raise KeyError, \
